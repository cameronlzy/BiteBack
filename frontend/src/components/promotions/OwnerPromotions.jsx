...
const OwnerPromotions = ({ user }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 px-4">
      ...
      <Button className="mb-6" onClick={() => navigate("/promotions/new")}>
        Add New Promotion
      </Button>
      {promotions.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              {currentPromotions.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">No current promotions</p>
              )}
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-2">Past Promotions</h3>
              {pastPromotions.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">No past promotions</p>
              )}
            </div>
          </div>
        </Fragment>
